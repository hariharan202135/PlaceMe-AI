...
import { LogIn, Key, Mail, ShieldAlert, Sparkles, Sun, Moon, Eye, EyeOff, X, ArrowRight, User as UserIcon } from 'lucide-react';
          ...
          <div className="bg-card border border-border rounded-2xl p-6 max-w-md w-full shadow-2xl space-y-5 text-left relative z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold text-base text-foreground">Sign in with Google</h3>
      ...
      <div className="max-w-md w-full space-y-8 glass p-8 rounded-2xl shadow-xl relative z-10">
        ...
        <div>
          <button
            ...
            disabled={isSubmitting}
            className="w-full flex items-center justify-center space-x-2.5 py-3 border border-border bg-card hover:bg-card/80 rounded-xl text-sm font-medium transition duration-150"
          >
